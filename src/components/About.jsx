  ...
  return (
    <section id="about" className="mx-auto max-w-6xl px-6 py-20">
      ...
      <div className="grid gap-10 md:grid-cols-2 md:items-center">
        ...
        <div className="relative mx-auto aspect-4/3 w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-linear-to-br from-slate-100 to-slate-200 dark:border-slate-800 dark:from-slate-800 dark:to-slate-900">
